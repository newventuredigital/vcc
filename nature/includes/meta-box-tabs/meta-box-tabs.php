...
if ( ! class_exists( 'RWMB_Tabs' ) )
{
	class RWMB_Tabs
	{
		...
		function admin_enqueue_scripts()
		{
			...
			//wp_enqueue_script( 'rwmb-show-hide', get_template_directory_uri() . '/includes/meta-box-show-hide/show-hide.js' , array( 'jquery' ), '0.1.0', true );
			wp_enqueue_style( 'rwmb-tabs', get_template_directory_uri() . '/includes/meta-box-tabs/tabs.css', __FILE__ ) ;
			wp_enqueue_script( 'rwmb-tabs', get_template_directory_uri(). '/includes/meta-box-tabs/tabs.js', __FILE__ , array( 'jquery' ), '0.1', true );
		}
